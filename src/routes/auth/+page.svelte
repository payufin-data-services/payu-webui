...
<div class="w-full h-screen max-h-[100dvh] text-white relative">
  <div
    style="background-image: url('{WEBUI_BASE_URL}/static/background.png');"
    class="w-full h-full absolute top-0 left-0 bg-cover bg-center z-0"
  ></div>
  {#if loaded}
    ...
    >
      <div class="w-full sm:max-w-md px-10 min-h-screen flex flex-col text-center">
        ...
        {:else}
          <div class="my-auto pb-10 w-full dark:text-gray-100 bg-white p-6">
            <form
